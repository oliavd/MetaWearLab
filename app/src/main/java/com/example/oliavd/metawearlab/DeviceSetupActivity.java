package com.example.oliavd.metawearlab;
...
import com.example.oliavd.metawearlab.DeviceSetupActivityFragment.*;
...
public class DeviceSetupActivity extends AppCompatActivity implements ServiceConnection, FragmentSettings {
    public final static String EXTRA_BT_DEVICE= "com.example.oliavd.DeviceSetupActivity.EXTRA_BT_DEVICE";

    public static class ReconnectDialogFragment extends DialogFragment implements  ServiceConnection {
        private static final String KEY_BLUETOOTH_DEVICE = "com.example.oliavd.DeviceSetupActivity.ReconnectDialogFragment.KEY_BLUETOOTH_DEVICE";
